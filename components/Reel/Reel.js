        ...
        <div className="row">
          <div className="col-12">
            <div className="card mk-p-rl mk-pt-45 mk-pb-15 mb-5">
              <img className="card-img-top" src="mk-job-giinger.png" alt="Card image cap" loading="lazy"/>
            ...
            <div className="card mk-p-rl mk-pt-45 mk-pb-15 mb-5">
              <img className="card-img-top" src="mk-job-casio.png" alt="Card image cap" loading="lazy"/>
              <div className="card-body">
